...
CATEGORIES_KEYWORDS = {
    ...
    "Contra": ["self transfer", "own account", "transfer to self", "self transfer to", "own a/c", "internal transfer", "to self"]
}
...
def categorize_transaction(
    ...
    if settings.OPENAI_API_KEY and "your-openai-api-key" not in settings.OPENAI_API_KEY:
        try:
            ...
            # Clean response
            for cat in ["Groceries", "Dining", "Transport", "Utilities", "Rent", "Entertainment", "Shopping", "Investment", "Contra"]:
